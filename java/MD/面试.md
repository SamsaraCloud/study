...
​		先添加实现了 PriorityOrdered 接口 /praɪˈɔːrəti/

​		再添加实现 Ordered 接口

​		再添加普通的

​		最后添加 MergedBeanDefinitionPostProcessor 内部的后置处理器
...
F:\git\study\java\MD\image\image-20200324221617558.png